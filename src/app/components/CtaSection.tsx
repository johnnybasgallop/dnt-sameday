  ...
  return (
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-[var(--primary)] opacity-80"></div>
      </div>
      ...
      <div className="px-6 md:px-15 lg:px-20 2xl:px-30  relative z-10">
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[var(--primary)] mb-4">Need a Delivery Solution?</h2>
            <p className="text-[var(--steel-grey)] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[var(--section-grey)] rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[var(--primary)] mb-2">Call Us Directly</h3>
              <p className="text-[var(--steel-grey)] mb-4">Our team is available 24/7 to assist with your delivery needs.</p>
            ...
            <div className="bg-[var(--section-grey)] rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[var(--primary)] mb-2">Request a Quote</h3>
              <p className="text-[var(--steel-grey)] mb-4">Fill out our simple form and we'll get back to you promptly.</p>
