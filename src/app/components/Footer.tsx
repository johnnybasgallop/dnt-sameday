  ...
  return (
    <footer className="bg-[var(--primary)] text-white">
      <div className="px-6 md:px-15 lg:px-20 2xl:px-30  pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center mb-2">
              ...
              <a href="tel:+441234567890" className="hover:text-[var(--light-grey)]">+44 (0) 1234 567890</a>
            </div>
            <div className="flex items-center mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@dntsameday.co.uk" className="hover:text-[var(--light-grey)]">info@dntsameday.co.uk</a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="hover:text-[var(--light-grey)]">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-[var(--light-grey)]">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-[var(--light-grey)]">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/fleet" className="hover:text-[var(--light-grey)]">
                  Our Fleet
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[var(--light-grey)]">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        {/* Copyright */}
        <div className="border-t border-[var(--steel-grey)]/20 mt-8 pt-6 text-center text-sm">
