        ...
        <div className="px-6 md:px-15 lg:px-20 2xl:px-30 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold text-primary mb-2">Swift Response</h3>
              <p className="text-steel-grey">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold text-primary mb-2">Rapid POD Delivery</h3>
              <p className="text-steel-grey">
        ...
        <div className="px-6 md:px-15 lg:px-20 2xl:px-30 ">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold text-primary mb-6">Insurance & Coverage</h2>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-secondary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <div>
                    <span className="font-semibold text-primary">£50,000 Goods-in-Transit Insurance</span>
                    <p className="text-steel-grey">Protecting your valuable items during transport.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-secondary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div>
                    <span className="font-semibold text-primary">£5 Million Public Liability Insurance</span>
                    <p className="text-steel-grey">Comprehensive coverage for all operations.</p>
                  </div>
                </li>
              </ul>

              <h3 className="text-xl font-bold text-primary mb-2">Service Coverage</h3>
              <p className="text-steel-grey mb-4">
      ...
      <section className="py-12 bg-secondary">
        <div className="px-6 md:px-15 lg:px-20 2xl:px-30  text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/contact" className="bg-primary text-white font-semibold px-6 py-2.5 rounded-md hover:bg-primary/80 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
